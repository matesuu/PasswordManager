...
def help() -> None:
        ...
        print("home - returns to main menu\n")
        print("ls - displays all current clients as a list\n")
        print("info - returns all associated login information with a given client\n")
        print("new - creates a new client-information pair in dictionary - Optional Flags: [-all] [-client]\n")
        print("rm - removes a specified cient password pair from dictionary]\n")
        print("cat - change a pre-existing password with an associated client\n")
        print("resset - deletes all currently existing client-password pairs held within data file\n")
        ...
        print("vrs - displays version info and credits")
